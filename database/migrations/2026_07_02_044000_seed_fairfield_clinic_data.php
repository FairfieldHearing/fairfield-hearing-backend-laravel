    ...
    public function up(): void
    {
        ...
        $locations = [
            ...
            [
                ...
                'phone' => '+919811418578',
                'whatsapp' => '919811551399',
                'google_maps_link' => 'https://maps.google.com/maps?q=FLAT%20NO%2048%2C%20GROUND%20FLOOR%2C%20DDA%20FLAT%2C%20POCKET%20B%2C%20SUKHDEV%20VIHAR%2C%20NEW%20DELHI-110025&t=&z=15&ie=UTF8&iwloc=&output=embed',
            ...
            [
                ...
                'phone' => '+919811418578',
                'whatsapp' => '919811551399',
                'google_maps_link' => 'https://maps.google.com/maps?q=SHOP%20NO-9%2C%20SULTAN%20MARKET%2C%20NEAR%20A%20P%20PUBLIC%20SCHOOL%2C%20KAMPIL%20ROAD%2C%20KAIMGANJ%2C%20FARRUKHABAD%2C%20U.P%20-%20209502&t=&z=15&ie=UTF8&iwloc=&output=embed',
        ...
        $postId = DB::table('blog_posts')->insertGetId([
            ...
            'content' => json_encode([
                ['type' => 'paragraph', 'data' => ['text' => 'For most senior citizens, the best hearing aids are <strong>rechargeable receiver-in-canal (RIC) devices with automatic noise management and simple Bluetooth</strong>. They are easy to handle, comfortable for all-day wear and clear in conversation. In 2026, our audiologists most often recommend the <strong>Phonak Infinio, Signia IX, ReSound Vivia, Widex Moment and Bernafon Encanta</strong> families for older adults.']],
                ['type' => 'takeaways', 'data' => ['title' => 'Key takeaways', 'items' => [
                    'Prioritise <strong>easy handling</strong> (rechargeable, no fiddly batteries), <strong>clear speech in noise</strong> and dependable aftercare.',
                    'RIC and BTE styles suit most seniors; tiny invisible styles can be hard for limited dexterity or eyesight.',
                    'A quality pair typically costs about <strong>₹50,000 to ₹3,00,000+</strong>, with EMI and free trials widely available.',
                    'A professional hearing test and a real-life trial matter more than any single “best” model.'
                ]]],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => 'What makes a hearing aid good for seniors?']],
                ['type' => 'paragraph', 'data' => ['text' => 'Older adults usually value reliability and simplicity over gadgetry. The features that matter most are:']],
                ['type' => 'list', 'data' => ['items' => [
                    '<strong>Easy handling:</strong> rechargeable batteries remove the need to change tiny cells; larger or app-based controls help.',
                    '<strong>Speech clarity in noise:</strong> modern AI sound processing lifts voices above background noise in restaurants and family gatherings.',
                    '<strong>Comfort for all-day wear:</strong> lightweight, well-fitted devices that don’t block the ear.',
                    '<strong>Connectivity:</strong> direct streaming of phone calls and TV, which is a real quality-of-life boost.',
                    '<strong>Local support & aftercare:</strong> easy servicing, cleaning and follow-up tuning close to home.'
                ]]],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => 'Our top picks for seniors in 2026']],
                ['type' => 'table', 'data' => [
                    'headers' => ['Model family', 'Best for', 'Why seniors like it'],
                    'rows' => [
                        ['Phonak Infinio 50/70', 'Conversations in noise', 'Advanced speech processing, robust and rechargeable'],
                        ['Signia IX (3IX / 5IX)', 'Natural own-voice', 'Conversation enhancement, slim and comfortable'],
                        ['ReSound Vivia 5', 'All-day comfort', 'Lightweight with deep-learning noise reduction'],
                        ['Widex Moment 220', 'Natural sound', 'Very natural, smooth sound quality'],
                        ['Bernafon Encanta 200', 'Value clarity', 'Clear performance at a sensible price']
                    ]
                ]],
                ['type' => 'paragraph', 'data' => ['text' => 'The “right” model depends on your hearing test results, lifestyle and budget — which is why we always recommend a trial before buying.']],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => 'Which style is best for older adults?']],
                ['type' => 'paragraph', 'data' => ['text' => 'For most seniors we suggest <a href="/ric">Receiver-in-Canal (RIC)</a> or <a href="/bte">Behind-the-Ear (BTE)</a> styles. They are easier to insert and clean, support rechargeable batteries and offer the most power. Very small <a href="/invisible">invisible (IIC/CIC)</a> aids look discreet but can be fiddly for those with arthritis or reduced eyesight. If batteries are a worry, choose a <a href="/rechargeable">rechargeable</a> model.']],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => 'How much do they cost in India?']],
                ['type' => 'paragraph', 'data' => ['text' => 'Senior-friendly hearing aids generally range from about <strong>₹50,000 for a good mid-range pair to ₹3,00,000+ for premium technology</strong>. Rechargeable and Bluetooth features sit at the higher end. EMI and free trials are widely available, so you can experience the benefit before committing. See our <a href="/blog/prices/">Prices & Cost guides</a> for detailed figures. <em>(Prices are indicative and vary by model and offer.)</em>']],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => 'How to choose the right one']],
                ['type' => 'paragraph', 'data' => ['text' => 'Start with a professional hearing test, then trial the recommended device in your own daily life — at home, on the phone and in noisy places. Judge each aid on comfort, clarity and ease of use, and choose a clinic that offers strong aftercare and follow-up tuning. The best hearing aid is the one that fits <em>your</em> ears, hearing and routine — not simply the most expensive.']]
            ]),
        ...
        $postId = DB::table('blog_posts')->insertGetId([
            ...
            'content' => json_encode([
                ['type' => 'paragraph', 'data' => ['text' => 'For severe to profound hearing loss, the best hearing aids are <strong>high-power “superpower” or “ultra-power” Behind-the-Ear (BTE) models</strong> with strong amplification, feedback control and AI noise management. In 2026 the standout performers are the <strong>Phonak Naída, Signia Motion SP IX, ReSound Enzo, Widex Moment SP and Bernafon Leox</strong> power families.']],
                ['type' => 'takeaways', 'data' => ['title' => 'Key takeaways', 'items' => [
                    'Severe-to-profound loss needs <strong>power BTE</strong> hearing aids — small invisible styles cannot deliver enough output.',
                    'Look for high gain/output, strong <strong>feedback cancellation</strong>, and a custom earmould for a secure, leak-free fit.',
                    'Top families: Phonak Naída, Signia Motion SP IX, ReSound Enzo, Widex Moment SP, Bernafon Leox.',
                    'Realistic expectations and expert programming matter as much as the device itself.'
                ]]],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => 'What counts as severe to profound loss?']],
                ['type' => 'paragraph', 'data' => ['text' => 'Hearing loss is graded by the quietest sounds you can hear, measured in decibels (dB HL). <strong>Severe</strong> loss is roughly 71–90 dB HL and <strong>profound</strong> loss is 91 dB HL or greater. At these levels you may miss most conversation without aids and rely heavily on volume and visual cues. A <a href="/book-a-test">professional hearing test</a> confirms your exact levels and the power you need.']],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => 'Best power hearing aids for 2026']],
                ['type' => 'table', 'data' => [
                    'headers' => ['Model family', 'Type', 'Strength'],
                    'rows' => [
                        ['Phonak Naída (Lumity/Infinio)', 'Superpower / Ultra-power BTE', 'Market-leading power and speech-in-noise'],
                        ['Signia Motion SP IX', 'Superpower BTE', 'Strong output with conversation enhancement'],
                        ['ReSound Enzo IA', 'Superpower BTE', 'Rich, comfortable sound with great connectivity'],
                        ['Widex Moment SP', 'Superpower BTE', 'Natural sound quality at high power'],
                        ['Bernafon Leox SP/UP', 'Super / Ultra-power BTE', 'Dependable power and value']
                    ]
                ]],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => 'Why BTE and power receivers?']],
                ['type' => 'paragraph', 'data' => ['text' => 'Power <a href="/bte">Behind-the-Ear (BTE)</a> aids house a larger amplifier and battery, so they can deliver the high gain that severe-to-profound loss requires while controlling feedback (whistling). They are usually paired with a <strong>custom earmould</strong> that seals the ear canal — essential for both power and comfort. Tiny invisible aids simply cannot produce enough output for these losses.']],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => 'What results to expect']],
                ['type' => 'paragraph', 'data' => ['text' => 'Well-fitted power aids can restore a great deal of speech understanding, but expectations should be realistic: outcomes depend on how long the loss has been present and on the health of the hearing nerve. Expert, evidence-based programming — and follow-up fine-tuning — is what turns raw power into real-world clarity. In some profound cases, a <strong>cochlear implant</strong> may be discussed; our team can advise and refer where appropriate.']],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => 'Cost and next steps']],
                ['type' => 'paragraph', 'data' => ['text' => 'Power hearing aids span a wide range depending on technology level and brand. Book a <a href="/book-a-test">free hearing test</a> to confirm your levels, then trial a recommended power model with a proper earmould. For pricing and EMI, see our <a href="/blog/prices/">Prices & Cost guides</a>. <em>(Prices are indicative and vary by model.)</em>']]
            ]),
            'author_name' => 'Wasiq Ali Khan',
        ...
        $postId = DB::table('blog_posts')->insertGetId([
            ...
            'content' => json_encode([
                ['type' => 'paragraph', 'data' => ['text' => 'The <strong>Signia Styletto IX</strong> is a slim, rechargeable hearing aid that comes in three technology tiers: <strong>7IX (premium), 5IX (advanced) and 3IX (essential)</strong>. They look identical and share the same signature sound — the difference is how much automatic processing and how many features you get. In short: <strong>7IX</strong> suits busy, demanding listeners; <strong>5IX</strong> is the balanced all-rounder; <strong>3IX</strong> covers everyday quieter lifestyles.']],
                ['type' => 'takeaways', 'data' => ['title' => 'Key takeaways', 'items' => [
                    'All three share the same <strong>slim design, rechargeable battery and Bluetooth</strong> — only the technology tier changes.',
                    '<strong>Higher tiers</strong> add more automatic programs and stronger speech-in-noise performance for complex environments.',
                    'Choose by <strong>lifestyle and noise exposure</strong>, not looks — your audiologist can match the tier to your routine.',
                    'A trial is the best way to feel the difference between tiers in your own life.'
                ]]],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => 'What the Styletto IX series is']],
                ['type' => 'paragraph', 'data' => ['text' => 'The Styletto IX stands out for its slim, pen-like design, portable charging case and Signia’s “Integrated Xperience” platform with RealTime Conversation Enhancement. It is a <a href="/ric">Receiver-in-Canal</a> style aimed at people who want a discreet, modern look with strong speech clarity.']],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => '7IX vs 5IX vs 3IX at a glance']],
                ['type' => 'table', 'data' => [
                    'headers' => ['', 'Styletto 7IX', 'Styletto 5IX', 'Styletto 3IX'],
                    'rows' => [
                        ['Tier', 'Premium', 'Advanced', 'Essential'],
                        ['Automatic programs', 'Most', 'More', 'Core'],
                        ['Speech in noise', 'Excellent', 'Very good', 'Good'],
                        ['Best for', 'Busy, noisy lifestyles', 'Mixed daily life', 'Quieter, routine settings'],
                        ['Design / rechargeable / Bluetooth', 'Same', 'Same', 'Same']
                    ]
                ]],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => 'How the tiers differ']],
                ['type' => 'paragraph', 'data' => ['text' => 'Think of the tiers as how “smart” and automatic the hearing aid is. The <strong>7IX</strong> reacts fastest and most precisely as your surroundings change — ideal if you’re often in restaurants, meetings or crowds. The <strong>5IX</strong> handles most everyday situations very well and is the popular middle choice. The <strong>3IX</strong> delivers clear, comfortable hearing for calmer, more predictable environments at a friendlier price.']],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => 'Which one should you choose?']],
                ['type' => 'list', 'data' => ['items' => [
                    '<strong>Choose 7IX</strong> if you have an active social or working life with lots of background noise.',
                    '<strong>Choose 5IX</strong> if you want excellent everyday performance and value — the best all-round pick for most people.',
                    '<strong>Choose 3IX</strong> if your days are mostly quiet (home, one-to-one chats, small groups) and budget is a priority.'
                ]]],
                ['type' => 'heading', 'data' => ['level' => 2, 'text' => 'Price and trial']],
                ['type' => 'paragraph', 'data' => ['text' => 'Within a series, higher tiers cost more because of the added processing. The best way to decide is to <a href="/book-a-test">book a free hearing test</a> and trial the recommended tier in your own daily life. For broader pricing, see our <a href="/blog/prices/">Prices & Cost guides</a>. <em>(Prices are indicative and vary by offer.)</em>']]
            ]),
            'author_name' => 'Wasiq Ali Khan',
