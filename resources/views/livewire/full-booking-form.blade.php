<div class="hero__card" style="box-shadow: var(--shadow);" x-data="{ isDisabled: false }" @full-booking-success.window="window.open('https://wa.me/919811551399?text=' + encodeURIComponent($event.detail.msg), '_blank')">
    <h3 class="mt0">Your details</h3>
    <form class="hero__form" wire:submit.prevent="submit">
        ...
        <div class="field">
            <label for="b-clinic">Preferred clinic *</label>
            <select
                id="b-clinic"
                name="clinic"
                required
        ...
        <div class="field">
            <label for="b-time">Preferred day / time</label>
            <input
                id="b-time"
                name="time"
                type="text"
        ...
        <div class="field">
            <label for="b-msg">Anything we should know? (optional)</label>
            <textarea
                id="b-msg"
                name="message"
                rows="3"
                placeholder="Your concern, who the test is for, etc."
                wire:model="message"
                :disabled="isDisabled"
            ></textarea>
        </div>
